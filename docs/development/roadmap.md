...
| **M3 Tracks and logs** | GPX track and route following, KML tracks, interpolation without timestamps, log recording and replay with pause, step and seek | 0.4.0 |
...
- Replay of plain third-party NMEA logs.
